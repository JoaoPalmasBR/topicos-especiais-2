...
<head>
    <meta charset="UTF-8">
    <title>codePRO</title>
    <script>localStorage.removeItem('subiu');</script>
    <style>
        html {
            margin: 0;
            padding: 0;
...
<div class="container">
    ...
    <div class="text">
        <div class="text-inner">
            ...
            <h2> Você se superou, bem vindo ao próximo nivel! </h2>

            <button id="home" class="button">
                <h3 onclick="muda()" ondblclick="muda2()" id="botao"> Clique</h3>
            </button>
            <script>
                var x = null;
                function muda(){
                    if (x== null){
                        x = "Esse Botão nao faz nada mas obrigado <br> por clicar.";
                    }
                    else {
                        if (x== "Esse Botão nao faz nada mas obrigado <br> por clicar."){
                            x = "PARA DE CLICAR.";
                        }
                    }
                    document.getElementById("botao").innerHTML = x;
                }
            </script>
        </div>
...
echo "<script>setTimeout(function(){location.assign('../../../loading.html')} , 15000);</script>";
}
}
?>